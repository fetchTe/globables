declare global {
  ...
  // QuickJS - Return an object containing the environment variables as key-value pairs.
  // @see {@link https://bellard.org/quickjs/quickjs.html#Global-objects}
  // @see {@link https://quickjs-ng.github.io/quickjs/stdlib#getenviron}
  var getenviron: (()=> Record<string, string>) | undefined;
}
